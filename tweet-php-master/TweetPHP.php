 ...
 class TweetPHP {
    ...
    public function  __construct ($options = array()) {
      ...
      array(
          ...
          'twitter_date_text'     => array('detik', 'menit', 'sekitar', 'jam', 'yang lalu'),
          'date_format'           => '%A, %e %B %Y', // The defult date format e.g. 12:08 PM Jun 12th. See: http://php.net/manual/en/function.strftime.php
          'date_lang'             => 'id_ID', // Language for date e.g. 'fr_FR'. See: http://php.net/manual/en/function.setlocale.php
    ...
    private function parse_tweet ($tweet) {
      ...
      return $this->options['tweet_wrap_open'] . $tweet_text . $this->options['tweet_wrap_close'] . $this->options['meta_wrap_open'] . $display_time . $this->options['meta_wrap_close'];
    }
